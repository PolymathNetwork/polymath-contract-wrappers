...
describe('RestrictedPartialSaleTransferManagerWrapper', () => {
  // we extend the class to be able to instance it, using the 3.0.0 RestrictedPartialSaleTransferManager contract since it has all common functionality
  class FakeRestrictedPartialSaleTransferManager extends RestrictedPartialSaleTransferManagerCommon {
  ...
  beforeAll(() => {
    ...
    target = new FakeRestrictedPartialSaleTransferManager(
