...
import { ContractVersion, GetLogs, GetLogsAsyncParams, Subscribe, SubscribeAsyncParams } from '../../../types';
import assert from '../../../utils/assert';

/**
 * This class includes the functionality related to interacting with the AlternativeERC20 contract.
 */
export default class AlternativeERC20Common extends ERC20TokenWrapper {
